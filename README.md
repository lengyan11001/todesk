...
- Android APK: `E:\BHZN-ToDesk\android\manual-build\out\bhzn-todesk-debug-v0.1.3-4.apk`
...
powershell -ExecutionPolicy Bypass -File .\build-apk.ps1 -Channel debug -VersionCode 4 -VersionName 0.1.3
```
