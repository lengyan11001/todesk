...
- Android APK: `E:\BHZN-ToDesk\android\manual-build\out\bhzn-todesk-debug-v0.1.6-7.apk`
...
powershell -ExecutionPolicy Bypass -File .\build-apk.ps1 -Channel debug -VersionCode 7 -VersionName 0.1.6
```
