...
- Android APK: `E:\BHZN-ToDesk\android\manual-build\out\bhzn-todesk-debug-v0.1.5-6.apk`
...
powershell -ExecutionPolicy Bypass -File .\build-apk.ps1 -Channel debug -VersionCode 6 -VersionName 0.1.5
```
